...
b16_en2=pygame.transform.scale(b16,(186,6))
...
b17_en21=pygame.transform.scale(b17,(170,6))
b17_en22=pygame.transform.scale(b17,(140,6))
b17_en23=pygame.transform.scale(b17,(110,6))
b17_en24=pygame.transform.scale(b17,(80,6))
b17_en25=pygame.transform.scale(b17,(50,6))
b17_en26=pygame.transform.scale(b17,(20,6))
...
zidan3=pygame.image.load("bullet.png")
zidan3=pygame.transform.scale(zidan3,(34,54))
...
en2_x=random.randint(0,200)
en2_y=random.randint(0,200)
# en_down1_y=[]
# en_down3_y=[]
# en_down4_y=[]
# for i in range(8):
...
while True:
    ...
    if game_start==1:
        ...
        if flag_en2==0:
            screen.blit(b16_en2,(en2_x-10,en2_y-12))
        ...
        if time:
            ...
            zi3_x.append(en2_x+58)
            zi3_y.append(en2_y+70)
            time = 2
        for i in range(len(zi_x)):
            ...
            if flag_en2==0:
                screen.blit(zidan3,(zi3_x[i]+10,zi3_y[i]+40))
            ...
            if flag6==0:
                ...
                # screen.blit(b17,(en_x+6,en_y-5))
            if flag6==1:
                screen.blit(enemy2_down1, (en2_x, en2_y))
                screen.blit(b17_en26, (en2_x-10, en2_y-12))
            if flag6==2:
                screen.blit(enemy2_down3, (en2_x, en2_y))
                screen.blit(b17_en25, (en2_x-10, en2_y-12))
            if flag6==3:
                screen.blit(enemy2_down4, (en2_x, en2_y))
                screen.blit(b17_en24, (en2_x-10, en2_y-12))
            if flag6==4:
                screen.blit(enemy2_down5, (en2_x, en2_y))
                screen.blit(b17_en23, (en2_x-10, en2_y-12))
            if flag6==5:
                screen.blit(enemy2_down6, (en2_x, en2_y))
                screen.blit(b17_en22, (en2_x-10, en2_y-12))
            if en2_x < zi_x[i] < en2_x + enemy2_width and en2_y < zi_y[i] < en2_y + enemy2_height:  # 子弹碰到小战机条件
                zi_y[i]=random.randint(-1500,-1200)
                flag7+= 1  # 随着循环逐渐增加子弹射中的次数
                print("flag7=%d" % flag7)
                if 10 < flag7< 100:
                    flag6 = 1
                    screen.blit(enemy2, (200, -180))
                elif 100 < flag7 < 200:
                    flag6 = 2
                    screen.blit(enemy2_down1, (200, -180))
                elif 200 < flag7< 300:
                    flag6 = 3
                    screen.blit(enemy2_down3, (200, -180))
                if 300<flag7<400:
                    flag6= 4
                    screen.blit(enemy2_down4, (200, -180))
                    screen.blit(enemy2, (200, -100))
                elif 400 < flag7< 500:
                    flag6 = 5
                    screen.blit(enemy2_down5, (200, -180))
                if flag7 == 500:
                    flag6= 6
                    screen.blit(enemy2_down6, (200, -180))
                    screen.blit(enemy2, (200, -100))
                if flag7 > 500:
                    flag_en2=1
            ...
            if flag44 == 4:
                ...
                if blood==1:
                    screen.blit(b21, (mouse_x - hero_width / 2, mouse_y - hero_height / 2))
                    screen.blit(b17_hr2, (mouse_x - hero_width + 30, mouse_y + hero_height / 2 - 18))
            if mouse_x - 30 < zi3_x[i] < mouse_x - 30 + hero_width and mouse_y - hero_height / 2 < zi3_y[i] < mouse_y - hero_height / 2 + hero_height:  # 子弹碰到小战机条件
                zi3_y[i]=random.randint(1200,1800)
                flag2+= 1  # 随着循环逐渐增加子弹射中的次数
                print("flag2=%d" % flag2)
                if 20 < flag2< 100:
                    flag44 = 1
