...
# 加载游戏资源
plane_img = pygame.image.load('images/hero1.png')
# xk = pygame.image.load('xk.jpg')
bullet_img = pygame.image.load('images/bullet1.png')
bullet1_img = pygame.image.load('images/bullet2.png')
enemy_img = pygame.image.load('images/enemy0.png')
...
supply = Supply(pygame.image.load('images/prop_type_0.png'),
...
# 敌军爆炸列表
enemy0_img = pygame.image.load('images/enemy0.png')
enemy0_blow_list = [
    pygame.image.load('images/enemy0_down1.png'),
