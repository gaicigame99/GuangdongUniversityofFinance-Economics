...
def begin():
    class jiangshi1(object):
        def __init__(self, _screen, _x, _y):
            self.image = pygame.image.load("image//僵尸.png")
            self.x = _x
            self.list_x = []
            self.y = _y
            self.list_y = []
    ...
    class wandousheshou(object):
        def __init__(self, _screen, _x, _y):
            self.image = pygame.image.load("image//射手.png")
            self.zidan = pygame.image.load("image//子弹.png")
    ...
    class xiangrikui(object):
        def __init__(self, _screen, _x, _y):
            self.image = pygame.image.load("image//向日葵.png")
            self.x = _x
            self.list_x = []
            self.y = _y
            self.list_y = []
            ...
            self.sunshiney = 100
            self.screen = _screen
            self.taiyang = pygame.image.load("image//小太阳.png")
    ...
    background1 = pygame.image.load("image//u=1844012553,3000876172&fm=27&gp=0.jpg")    #导入花园背景
    background1 = pygame.transform.scale(background1, (1060, 629))
    yangguang = pygame.image.load("image//太阳.png")                           #导入阳光
    xiaotaiyang = pygame.image.load("image//小太阳.png")
    bianlitie = pygame.image.load("image//贴纸.png")
    bianlitie = pygame.transform.scale(bianlitie, (80, 38))
    xuanzewandou = pygame.image.load("image//选择豌豆.jpg")                     #导入选择卡
    wandouqushile = pygame.image.load("image//豌豆去世了.jpg")
    xuanzewandou = pygame.transform.scale(xuanzewandou, (75, 95))
    wandouqushile = pygame.transform.scale(wandouqushile, (75, 95))
    xuanzexiangrikui = pygame.image.load("image//选择向日葵.jpg")
    xiangrikuiqushile = pygame.image.load("image//向日葵去世了.jpg")
